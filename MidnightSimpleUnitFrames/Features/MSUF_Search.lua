...
local INDEX = {
    ...
    -- Portrait Styling (dedicated Portraits panel)
    { label="Portrait Shape (Square / Circle)",
      hint="Portraits", pageKey="opt_portraits",
      keywords={"portrait shape","square","circle","portrait circle","portrait form","portraitshape","kreis","rund"} },
    { label="Portrait Border (None / Solid / Class Color / Reaction / Custom)",
      hint="Portraits", pageKey="opt_portraits",
      keywords={"portrait border","portrait rahmen","border style","border color","class color border","reaction border","portrait outline","rahmen","umrandung","portrait rand"} },
    { label="Portrait Background",
      hint="Portraits", pageKey="opt_portraits",
      keywords={"portrait background","portrait bg","portrait hintergrund","dark background","portrait backdrop"} },
    { label="Portrait Size Override",
      hint="Portraits", pageKey="opt_portraits",
      keywords={"portrait size","portrait größe","custom size","size override","portrait dimension"} },
    { label="Portrait Offset (X / Y)",
      hint="Portraits", pageKey="opt_portraits",
      keywords={"portrait offset","portrait position","portrait verschiebung","offset x","offset y"} },
    { label="Class Portrait Style (Blizzard / Rondo Colored / Rondo WoW)",
      hint="Portraits", pageKey="opt_portraits",
      keywords={"class portrait style","rondo","blizzard class icon","portrait pack","class icon style","portraitclassstyle","klassensymbol"} },
    { label="Portrait Border Color / Background Color",
      hint="Colors", pageKey="opt_colors",
      keywords={"portrait color","portrait border color","portrait background color","portrait bg color","portrait farbe","portraitcolor"} },
    ...
    { label="Highlight targeted boss frame",
      hint="Boss Frames › Boss Layout", pageKey="uf_boss",anchor="MSUF_UF_BossTargetHLCB",
      keywords={"highlight targeted boss","boss target highlight","boss highlight enable","boss target glow","boss target border toggle"} },
    ...
    { label="Purge border on / off — Target, Focus, ToT, Boss",
    ...
    { label="Boss target border on / off — highlights targeted boss frame",
      hint="Bars › Borders", pageKey="opt_bars",anchor="MSUF_BossTargetOutlineDropdown",
      keywords={"boss target border","boss target highlight","boss highlight","boss target outline","boss target indicator","targeted boss","boss glow","which boss targeted"} },
    ...
    { label="Elite / Rare name prefix (show + before name)",
      hint="Fonts › Name & Power Colors", pageKey="opt_fonts", anchor="MSUF_EliteNamePrefixCB",
      keywords={"elite prefix","rare prefix","name prefix","elite name","rare name","plus prefix","+ name","boss prefix","elite symbol","rare symbol", "rare", "elite"} },
    ...
    { label="Icicles tracker (Frost Mage)",
      hint="Class Resources", pageKey="classpower",
      keywords={"frost mage icicles","mage icicles","ice lance","frost class power","frost resource"} },
    ...
    { label="NPC Type Colors — color health bar by NPC type (Boss/Miniboss/Caster/Melee/Regular)",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCTypeEnableCB",
      keywords={"npc type color","npc type","boss color","miniboss color","caster color","melee color","regular color","classification color","elite type","elite color","lieutenant color","npc colour type","mob type color","platynator color","npc type enable"} },
    { label="NPC Type Colors — Color HP bar (Class Color mode only)",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCTypeColorBarCB",
      keywords={"npc type hp bar","npc type bar","color bar npc type","hp bar boss color","health bar npc type"} },
    { label="NPC Type Colors — Color name text",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCTypeColorTextCB",
      keywords={"npc type name text","npc type text","color text npc type","name text boss color","text npc type"} },
    { label="Boss NPC Color",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCType_npcBoss",
      keywords={"boss npc color","boss colour","worldboss color","boss bar color","boss health color"} },
    { label="Miniboss / Lieutenant NPC Color",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCType_npcMiniboss",
      keywords={"miniboss color","lieutenant color","miniboss colour","lieutenant colour","mini boss color"} },
    { label="Caster NPC Color",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCType_npcCaster",
      keywords={"caster npc color","caster colour","caster mob color","ranged npc color","paladin class npc"} },
    { label="Melee NPC Color",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCType_npcMelee",
      keywords={"melee npc color","melee colour","melee mob color","warrior npc color"} },
    { label="Regular NPC Color",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",anchor="MSUF_Colors_NPCType_npcRegular",
      keywords={"regular npc color","regular colour","normal npc color","trivial npc color","trash color"} },
    { label="Reset NPC Type Colors",
      hint="Colors › NPC Type Colors", pageKey="opt_colors",
      keywords={"reset npc type colors","restore npc type","default npc type colors","reset classification colors"} },
    ...
    { label="Boss target highlight color",
      hint="Colors › Mouseover", pageKey="opt_colors",
      keywords={"boss target highlight color","boss target color","boss highlight color","boss border color","boss target colour","boss glow color"} },
    ...
    { label="Class Power colors — Combo Points / Holy Power / Soul Shards / Chi / Arcane Charges / Runes / Empowered / Soul Fragments / Maelstrom / Astral Power / Eclipse / Stagger / Insanity / Whirlwind / Tip of the Spear / Icicles / Ebon Might / Resource Text",
      hint="Colors › Class Power Colors", pageKey="opt_colors",anchor="MSUF_Colors_ClassPowerTypeDropdown",
      keywords={"class power colors","combo points color","holy power color","soul shards color","chi color","arcane charges color","runes color","empowered color","soul fragments color","maelstrom color","astral power color","eclipse color","stagger color","insanity color","whirlwind color","tip of the spear color","icicles color","icicle color","frost mage color","ebon might color","resource text color","class bar color","class power colour"} },
    ...
    { label="Icicles color (Frost Mage)",
      hint="Colors › Class Power Colors", pageKey="opt_colors",anchor="MSUF_Colors_ClassPowerTypeDropdown",
      keywords={"icicles","icicle","icicles color","icicle color","frost mage color","frost mage icicle color"} },
