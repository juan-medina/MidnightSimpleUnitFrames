...
local MSUF_COPY_BASIC_FIELDS = {
    ...
    "portraitMode",
    "portraitRender",
    -- Portrait Decoration (MSUF_PortraitDecoration.lua)
    "portraitShape",
    "portraitSizeOverride",
    "portraitOffsetX",
    "portraitOffsetY",
    "portraitBorderStyle",
    "portraitBorderThickness",
    "portraitBorderColorR",
    "portraitBorderColorG",
    "portraitBorderColorB",
    "portraitBorderColorA",
    "portraitBgEnabled",
    "portraitBgColorR",
    "portraitBgColorG",
    "portraitBgColorB",
